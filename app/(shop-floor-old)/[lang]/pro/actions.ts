'use server';
import config from '@/app/(shop-floor-old)/[lang]/pro/config';
import {
  bmwValidation,
  fordValidation,
} from '@/app/(shop-floor-old)/[lang]/pro/lib/utils/dmcDateValidation';
import generatePalletQr from '@/app/(shop-floor-old)/[lang]/pro/lib/utils/generatePalletQr';
